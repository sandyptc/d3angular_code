...
var d3 = require("d3");
var WPieDonutSeriesComponent = (function () {
    function WPieDonutSeriesComponent(elementRef, dataService) {
        this.elementRef = elementRef;
        this.dataService = dataService;
        console.log("Initalizing constructor WPieSeriesComponent");
        this.d3Element = d3.select(this.elementRef.nativeElement);
    }
    WPieDonutSeriesComponent.prototype.ngOnChanges = function () {
        if (!this.metadata)
            return;
    ...
    WPieDonutSeriesComponent.prototype.drawseries = function (series, x) {
        ...
        if (this.metadata.animeReq) {
            ...
            g.append("text").transition().delay(function (d, i) { return i * 200; }).duration(200)
                ...
                .text(function (d) { return d.value; }).style({ "stroke": "black", "stroke-width": 0.5 });
        }
        else {
            g.append("path")
                .attr("d", arc)
    ...
    WPieDonutSeriesComponent.prototype.colorscales = function (category) {
        switch (category) {
    ...
    return WPieDonutSeriesComponent;
}());
__decorate([
    core_1.Input("metaseries"),
    __metadata("design:type", Array)
], WPieDonutSeriesComponent.prototype, "metaseries", void 0);
__decorate([
    core_1.Input("width"),
    __metadata("design:type", Object)
], WPieDonutSeriesComponent.prototype, "width", void 0);
__decorate([
    core_1.Input("height"),
    __metadata("design:type", Object)
], WPieDonutSeriesComponent.prototype, "height", void 0);
__decorate([
    core_1.Input("metadata"),
    __metadata("design:type", Object)
], WPieDonutSeriesComponent.prototype, "metadata", void 0);
WPieDonutSeriesComponent = __decorate([
    core_1.Component({
...
], WPieDonutSeriesComponent);
exports.WPieDonutSeriesComponent = WPieDonutSeriesComponent;
//# sourceMappingURL=wpiedonutseries.component.js.map